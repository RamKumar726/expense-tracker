    ...
    return(
        ...
        <div className="flex items-center justify-center min-h-screen bg-white dark:bg-gray-700">
            ...
            <div className="place-self-center mr-auto lg:col-span-7">
                <h1 className=" text-blue-900 mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">Manage Your Expenses Anywhere in Real Time</h1>
            ...
            <div className="container h-full px-6 py-24">
                ...
                <button  onClick={signIn} className="flex items-center bg-grey-400 dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
